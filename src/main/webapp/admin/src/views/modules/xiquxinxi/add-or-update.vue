  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.leixing"
                placeholder="类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="乐器类型" prop="leqileixing">
          <el-select v-model="ruleForm.leqileixing" placeholder="请选择乐器类型">
            <el-option
                v-for="(item,index) in leqileixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="乐器类型" prop="leqileixing">
	      <el-input v-model="ruleForm.leqileixing"
                placeholder="乐器类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  data() {
	...
	faburiqi : false,
            ...
            ruleForm: {
                  ...
                  leqileixing: [
                            { required: true, message: '乐器类型不能为空', trigger: 'blur' },
                                    	                                                              ],
                  geshou: [
                                    	                                                              ],
                  fengmian: [
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.leixing = true;
            continue;
	            	            ...
	            	            if(o=='leqileixing'){
            this.ruleForm.leqileixing = obj[o];
	    this.ro.leqileixing = true;
            continue;
          }
	            	            if(o=='geshou'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xiquxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiquxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
